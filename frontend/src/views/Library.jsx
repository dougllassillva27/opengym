...
export default function Library() {
  ...
  const base = allExercises(S).filter(e => (!bp || e.bp === bp) && (!ql || e.n.toLowerCase().includes(ql) || (e.nPt || '').toLowerCase().includes(ql) || (Array.isArray(e.aliases) ? e.aliases : []).some(a => a.toLowerCase().includes(ql)) || e.tg.includes(ql) || e.eq.includes(ql) || (e.desc || '').toLowerCase().includes(ql)))
